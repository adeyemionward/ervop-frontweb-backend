...
<head>
    ...
    <title>Our Work - Aisha Bello</title>
    <!-- Tailwind CSS CDN -->
...
<body class="bg-white text-gray-800">
    ...
    <header class="sticky top-0 bg-white/90 backdrop-blur-md z-50 border-b border-gray-200">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <nav class="hidden md:flex items-center space-x-8">
                ...
                <a href="#" class="text-blue-600 hover:text-blue-600 font-semibold transition-colors">Portfolio</a>
    ...
    <!-- Footer -->
    <footer id="contact" class="bg-gray-800 text-white mt-20">
